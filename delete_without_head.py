'''
Approach: copy the data of next node to the current node and join curr.next to curr.next.next
Time Complexity: O(1)
Space Complexity: O(1)

Passes all testcases in geeksforgeeks
'''
class Solution:
    ...
    def deleteNode(self,curr_node):
        ...
        if curr_node.next == None: curr_node = None
